...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      width="30px"height="30px" class=" img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SHOPPERS</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar">
      {{-- for to insert login image  --}}
<?php
$user=Auth::user();
?>
 ...
 <li class="nav-item">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="{{route('userprofiles')}}" class="nav-link">
                          <i class="nav-icon fas fa-copy"></i>
                          <p>
                            Userprofile
                          </p>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023-2024 <a href="https://adminlte.io">Shoppers.com</a>.</strong>
    All rights reserved.
