      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> 
            <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row mb-5">
                ...
                <div class="d-flex">
                  <div class="dropdown mr-1 ml-md-auto">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                      ...
                      <a class="dropdown-item" href="{{route('welcome')}}">{{$cate->title}}</a>
                     @endforeach
                    </div>
                  </div>
                  <div class="btn-group">
         ...
         width="250px" height="217.14px" alt="Image placeholder" class=""></a>
              ...
              {{-- <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="{{route('welcome.shopsingle')}}"><img src="images/shoe_1.jpg"
                       alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="{{route('welcome.shopsingle')}}">Corater</a></h3>
              ...
              {{-- <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="{{route('welcome.shopsingle')}}"><img src="images/cloth_2.jpg" 
                      alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="{{route('welcome.shopsingle')}}">Polo Shirt</a></h3>
                    <p class="mb-0">Finding perfect products</p>
                    <p class="text-primary font-weight-bold">Rs.50</p>
                  </div>
                </div>
              ...
              {{-- <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="{{route('welcome.shopsingle')}}"><img src="images/cloth_3.jpg"
                       alt="Image placeholder" class="img-fluid"></a>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="{{route('welcome.shopsingle')}}">T-Shirt Mockup</a></h3>
                    <p class="mb-0">Finding perfect products</p>
                    <p class="text-primary font-weight-bold">Rs.50</p>
                  </div>
                </div>
              ...
              {{-- <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="{{route('welcome.shopsingle')}}">
              ...
              {{-- <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="{{route('welcome.shopsingle')}}">Tank Top</a></h3>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                @foreach($category as $cate)
                <li class="mb-1"><a href="{{route('welcome')}}" class="d-flex"><span>{{$cate->title}}</span> 
              ...
              <div class="mb-4">
                ...
                <a href="#" class="d-flex color-item align-items-center" >
                  <span class="bg-danger color d-inline-block rounded-circle mr-2">
                    </span> <span class="text-black">Red (2,429)</span>
                </a>
                <a href="#" class="d-flex color-item align-items-center" >
                  <span class="bg-success color d-inline-block rounded-circle mr-2">
                    </span> <span class="text-black">Green (2,298)</span>
                </a>
                <a href="#" class="d-flex color-item align-items-center" >
